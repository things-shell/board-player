...
class BoardPlayerFlipcard extends LitElement {
  ...
  updated(change) {
    change.has('axis') && this._onAxisChanged(this.axis, change.get('axis'))
  }
...
customElements.define('board-player-flipcard', BoardPlayerFlipcard)
